...
1.  Wählen Sie die Registerkartenüberschrift **Peek Mode** (Vorschaumodus) aus, und wählen Sie auf der Registerkarte **Warteschlange** die Schaltfläche **Peek from Start** (Vorschau ab Start) aus.
