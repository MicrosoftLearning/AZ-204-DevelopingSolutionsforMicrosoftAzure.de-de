...
1.  Fügen Sie den folgenden Code hinzu, um den **Azure.Messaging.ServiceBus**-Namespace zu importieren, der im Paket **Azure. .Queues** enthalten ist, das aus NuGet importiert wurde:
...
1.  Aktualisieren Sie die Zeichenfolgenkonstante **serviceBusConnectionString**, indem Sie den Wert auf die **primäre Verbindungszeichenfolge** des Service Bus-Namespace festlegen, die Sie zuvor in diesem Lab aufgezeichnet haben.
...
1.  Überprüfen Sie die Datei **Program.cs**, die nun den folgenden Code enthalten sollte. Beachten Sie, dass der Platzhalter `<serviceBus-connection-string>` die Verbindungszeichenfolge für den Azure Service Bus-Zielnamespace darstellt:
...
1.  Aktualisieren Sie wie zuvor die Zeichenfolgenkonstante **serviceBusConnectionString**, indem Sie den Wert auf die **primäre Verbindungszeichenfolge** des **Service Bus**-Namespace festlegen, die Sie zuvor in diesem Lab aufgezeichnet haben.
...
1.  Überprüfen Sie die Datei **Program.cs**, die nun den folgenden Code enthalten sollte. Der Platzhalter `<serviceBus-connection-string>` stellt die Verbindungszeichenfolge für den Azure Service Bus-Zielnamespace dar:
