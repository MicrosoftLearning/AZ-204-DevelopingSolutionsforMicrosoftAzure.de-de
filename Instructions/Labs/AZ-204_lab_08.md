...
1. Führen Sie auf dem Blatt **Web-App erstellen** auf der Registerkarte **Grundlagen** die folgenden Aktionen aus:
    ...
    | Abschnitt **Tarif** | Wählen Sie **Tarife erkunden** und auf der Seite **App Service-Tarif auswählen** die Option **S1** und dann **Auswählen** aus. |
...
1. Führen Sie innerhalb des Abschnitts **HTTP-Antwort** die folgenden Aktionen aus:
    ...
    1. Wenn sich das Popup öffnet, um die Aktivierung der Ablaufverfolgung zu aktivieren, wählen Sie die Schaltfläche **Ablaufverfolgung für eine Stunde aktivieren** aus. 
