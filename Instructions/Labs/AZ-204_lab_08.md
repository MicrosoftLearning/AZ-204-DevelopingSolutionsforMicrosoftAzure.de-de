...
1.  Führen Sie auf dem Blatt **Web-App erstellen** auf der Registerkarte **Grundlagen** die folgenden Aktionen aus:
    ...
    | Abschnitt **Tarif** | Wählen Sie **Größe ändern** und auf dem Blatt **Spezifikationsauswahl** die Option **Alle Optionen anzeigen** aus. Wählen Sie anschließend **S1** und dann **Anwenden** aus. |
