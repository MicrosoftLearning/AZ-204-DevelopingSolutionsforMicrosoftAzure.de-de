...
1. Führen Sie auf dem Blatt **Funktions-App erstellen** auf der Registerkarte **Grundlagen** die folgenden Aktionen aus, und wählen Sie **Weiter: Speicher** aus:
   ...
   | Dropdownliste **Version**        | Wählen Sie **8 (LTS) I (Preview)** aus.                        |
...
1. Ersetzen Sie den Inhalt des automatisch generierten Codes der Funktion **FileParser** ab Zeile 19 durch den folgenden Code:
