...
1. Wählen Sie auf dem Blatt **Speicherkonten** die Speicherkontoinstanz **securestor** _[Ihr Name]_ aus.
...
1. Führen Sie auf dem Blatt **Zugriffsrichtlinie hinzufügen** die folgenden Aktionen aus, und wählen Sie dann **Hinzufügen** aus:
    ...
    | Einstellung                            | Aktion                                             |
    | ---------------------------------- | -------------------------------------------------- |
    | Dropdownliste **Anhand einer Vorlage konfigurieren** | Lassen Sie dieses Feld leer. |
