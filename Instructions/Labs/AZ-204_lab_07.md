...
1. Führen Sie auf der Registerkarte **Grundlagen** des Blatts **Schlüsseltresor erstellen** die folgenden Aktionen aus, und wählen Sie dann **Zugriffskonfiguration** aus:
...
1. Ändern Sie auf der Registerkarte **Zugriffskonfiguration** das Berechtigungsmodell in **Tresorzugriffsrichtlinie**.

1. Wählen Sie die Registerkarte **Überprüfen und erstellen** aus, und überprüfen Sie die Optionen, die Sie in den vorherigen Schritten ausgewählt haben.
...
1. Wählen Sie auf dem Blatt **Zugriffsrichtlinie erstellen** den Abschnitt **Berechtigungen** und anschließend die folgenden Optionen aus:
...
1. Löschen Sie den gesamten Inhalt im Code-Editor.

1. Fügen Sie den folgenden Code in die Datei **FileParser.cs** ein:
...
1. Es sollte nun eine Fehlermeldung angezeigt werden, die angibt, dass die Ressource nicht gefunden wurde.
   ...
   > **Hinweis**: Dies wird erwartet, da unser Container privat ist.
...
#### Aufgabe 3: Schreiben von Azure Blob Storage-Code mit dem Azure SDK für .NET

1. Aktualisieren Sie den Inhalt der Datei **FileParser.cs** mit dem folgenden Code:
...
#### Aufgabe 4: Bereitstellen und Überprüfen der Azure Functions-App
