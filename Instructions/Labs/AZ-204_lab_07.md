...
1. Führen Sie auf dem Blatt **Zugriffsrichtlinie hinzufügen** die folgenden Aktionen aus, und wählen Sie dann **Hinzufügen** aus:
    ...
    ![Screenshot, der die konfigurierten Einstellungen auf dem Blatt „Zugriffsrichtlinie hinzufügen“ (Prinzipal) veranschaulicht](./media/l07_add_access_policy_principal.png)
