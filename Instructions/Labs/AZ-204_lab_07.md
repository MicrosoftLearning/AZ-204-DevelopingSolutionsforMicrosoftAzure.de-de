...
1. Wählen Sie auf dem Blatt **Zugriffsrichtlinie erstellen** den Abschnitt **1 Berechtigungen** und dann die folgenden Optionen aus:
...
1. Wählen Sie den Abschnitt **2 Prinzipal** und dann die folgenden Optionen aus: 
...
1. Wählen Sie **4 Überprüfen + erstellen** und dann **Erstellen** aus.
