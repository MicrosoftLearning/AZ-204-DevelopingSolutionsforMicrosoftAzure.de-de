...
1. Stellen Sie auf der Registerkarte **Erweitert** sicher, dass **Aktivieren des öffentlichen Zugriffs für einzelne Container** aktiviert ist. Aktivieren Sie das Kontrollkästchen, wenn es nicht aktiviert ist.
