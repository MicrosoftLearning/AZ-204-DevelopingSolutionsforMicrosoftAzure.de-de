...
1.  Stellen Sie sicher, dass die Version der NuGet-Pakete `Microsoft.AspNetCore.Authentication.JwtBearer` und `Microsoft.AspNetCore.Authentication.OpenIdConnect` auf **6.0.6** festgelegt ist.

1.  Legen Sie die Version der NuGet-Pakete `Microsoft.Identity.Web` und `Microsoft.Identity.Web.UI` auf **1.25.0** fest.
...
1.  Führen Sie die folgenden Befehle aus, um die .NET-Web-App zu erstellen:
