...
1. Wählen Sie auf der Taskleiste das Symbol **Microsoft Edge** aus, und wählen Sie die Registerkarte aus, die das Azure-Portal anzeigt (<https://portal.azure.com>).
1. Wählen im **Navigations**bereich des Azure-Portals den Link **Ressourcengruppen** aus.
1. Wählen Sie auf dem Blatt **Ressourcengruppen** die Ressourcengruppe **Serverlos** aus, die Sie zuvor in diesem Lab erstellt haben.
...
1. Wählen Sie im automatisch angezeigten Bereich in der Dropdownliste **HTTP-Methode** die Option **GET** aus.
1. Wählen Sie **Ausführen** aus, um die Funktion zu testen.
1. Überprüfen Sie im **HTTP-Antwortinhalt** die Ergebnisse der Testausführung. Der JSON-Inhalt sollte nun den folgenden Code enthalten:
