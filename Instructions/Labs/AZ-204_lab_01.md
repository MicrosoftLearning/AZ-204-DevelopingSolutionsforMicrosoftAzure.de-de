...
> **Aktive Abonnements:** Falls Sie über mehrere Abonnements verfügen. Sie können jederzeit angeben, in welchem Abonnement Sie arbeiten möchten. Verwenden Sie dazu den Parameter subscription in Ihrem Befehl. Hier finden Sie weitere Informationen zum Verwalten von Abonnements mit der [Azure-Befehlszeilenschnittstelle](https://docs.microsoft.com/en-us/cli/azure/manage-azure-subscriptions-azure-cli) und [Azure PowerShell](https://docs.microsoft.com/en-us/powershell/azure/azurerm/manage-subscriptions-azureps?view=azurermps-6.13.0).
...
1. Führen Sie auf dem Blatt **Web-App erstellen** auf der Registerkarte **Grundlagen** die folgenden Aktionen aus, und wählen Sie **Weiter: Bereitstellung** aus:
    ...
    | Abschnitt **SKU und Größe**           | Übernehmen Sie den Standardwert. (Um die Kosten für diese Übung zu optimieren, wird die Verwendung der **SKU „Standard S1“** empfohlen.)                                    |
...
1. Wählen Sie auf der Registerkarte **Bereitstellung** zweimal **Weiter** aus, um zu **Überwachung** zu navigieren.
