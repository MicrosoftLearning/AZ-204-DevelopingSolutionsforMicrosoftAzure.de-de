...
## <a name="lab-overview"></a>Übersicht über das Lab 

<em>Sehen Sie sich dieses Video an, indem Sie mit der rechten Maustaste auf diesen [Videolink](https://youtu.be/UAnHqJSkmSY) klicken und dann „Link in neuem Tab öffnen“ oder „Link in neuem Fenster öffnen“ auswählen.</em>

![Alternativer Text](media/Lab01-Overview.png) 
