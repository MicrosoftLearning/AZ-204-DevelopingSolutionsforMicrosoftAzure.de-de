...
1. Wenn Sie die Registerkarte **Anwendungseinstellungen** im Abschnitt **Konfiguration** haben, führen Sie die folgenden Aktionen aus, und wählen Sie zuerst **Speichern** und dann **Weiter** aus.
...
1. Wenn Sie die Registerkarte **Anwendungseinstellungen** im Abschnitt **Konfiguration** nicht haben, überprüfen Sie, ob sie über den Link **Umgebungsvariablen** im Abschnitt **Einstellungen** verfügen, wählen Sie ihn aus, und führen Sie die folgenden Aktionen aus:

   | Einstellung                                        | Aktion                                                                                                                  |
   | ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
   | Registerkarte **Anwendungseinstellungen**                           |  Auswählen                                                                                                                 |
   | Erstes Textfeld, das in der Spalte **Name** verfügbar ist |  **StorageConnectionString**                                                                                            |   
   | Textfeld in der Spalte **Wert**                | Fügen Sie die Verbindungszeichenfolge für den Speicher ein, die Sie zuvor in Editor kopiert haben.                                               |
   | Klicken Sie unten auf **Übernehmen**                  | Daraufhin wird das Popup zum Bestätigen geöffnet                                                                                  | 
   | Klicken Sie im Popup auf **Bestätigen** | Dadurch wird der soeben eingegebene Konfigurationswert gespeichert. |
