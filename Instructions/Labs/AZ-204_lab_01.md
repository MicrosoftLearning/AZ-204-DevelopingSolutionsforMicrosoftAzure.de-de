...
1. Überprüfen Sie auf dem Blatt  **Zugriffsschlüssel**  einen beliebigen Schlüssel (über die Schaltfläche **Anzeigen**) und kopieren Sie dann den Wert eines der Felder  **Verbindungszeichenfolge**  in die Zwischenablage.
...
1. Führen Sie im Fenster **Neuer Container** die folgenden Aktionen aus:
   ...
   | Liste der **Anonymen Zugriffsebene** | Lassen Sie **Privat (kein anonymer Zugriff)** und wählen Sie dann **Erstellen**. |
...
1. Führen Sie im Abschnitt **Konfiguration** die folgenden Aktionen aus, und wählen Sie zuerst **Speichern** und dann **Weiter** aus.
   ...
   | Kontrollkästchen **Bereitstellungssloteinstellung**          | Behalten Sie den Standardwert bei, und wählen Sie dann **OK** aus, um das Popupdialogfeld zu schließen und zum Abschnitt **Konfiguration** zurückzukehren. |
      | Wählen Sie im oberen Menü **Speichern** aus.           | Dadurch wird der soeben eingegebene Konfigurationswert gespeichert. |
...
1. Führen Sie im Abschnitt **Konfiguration** die folgenden Aktionen aus, und wählen Sie zuerst **Speichern** und dann **Weiter** aus:
   ...
   | Einstellung    | Aktion |
   | --- |--- |
   | Registerkarte **Anwendungseinstellungen**  | **Neue Anwendungseinstellung** auswählen |
