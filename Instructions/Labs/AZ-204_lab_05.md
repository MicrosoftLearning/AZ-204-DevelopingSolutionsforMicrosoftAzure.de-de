...
1. Wechseln Sie zur Anwendung **Windows-Terminal**.
...
1. Wechseln Sie zurück zum Fenster **Visual Studio Code**, und öffnen Sie im Bereich **Explorer** die **Dockerfile**-Datei.
...
1. Wählen Sie im Bereich **Cloud Shell** die Schaltfläche „Hochladen/Herunterladen“aus (dargestellt durch eine gefaltete Seite mit zwei Pfeilen, die in entgegengesetzte Richtungen zeigen, in der unteren rechten Ecke), und wählen Sie im Dropdownmenü **Hochladen** aus.

1. Navigieren Sie im Dialogfeld **Öffnen** zu dem leeren Verzeichnis **Allfiles (F):\\Allfiles\\Labs\\05\\Starter\\func**, wählen Sie **lab05.zip** aus, und wählen Sie dann **Öffnen** aus.
...
1. Wählen Sie den vom Befehl `az containerapp create` zurückgegebenen Link aus, um zu überprüfen, ob die Container-App ausgeführt wird.
