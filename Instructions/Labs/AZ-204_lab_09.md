...
1. Wählen Sie im Azure-Portal das Symbol **Cloud Shell** (![Cloud Shell-Symbol](./media/az204_lab_CloudShell.png)) aus, um eine Cloud Shell zu öffnen. Wenn Cloud Shell standardmäßig eine PowerShell-Sitzung verwendet, wählen Sie im Menü**zu Bash wechseln** in der **Cloud Shell** aus, und wählen Sie dann **Bestätigen** aus.
...
1. Führen Sie auf dem Blatt **Web-App erstellen** auf der Registerkarte **Grundlagen** die folgenden Aktionen aus, und wählen Sie die Registerkarte **Docker** aus:
