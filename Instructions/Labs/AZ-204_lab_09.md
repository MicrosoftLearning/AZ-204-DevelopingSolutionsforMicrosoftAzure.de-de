...
1. Fügen Sie den folgenden Code hinzu und ersetzen Sie **\<topic-endpoint\>**  und **\<topic-key\>**  mit Werten, die Sie im vorherigen Schritt aufgezeichnet haben:
...
1. Fügen Sie der **Main**-Methode der **Program.cs** -Datei den folgenden Code hinzu:
