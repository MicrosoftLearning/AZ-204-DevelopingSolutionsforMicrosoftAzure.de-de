...
1. Führen Sie den folgenden Befehl aus, um Version 4.11.0 von **Azure.Messaging.EventGrid** aus NuGet zu importieren:
    ...
    > **Hinweis:** Mit dem Befehl **dotnet add package** wird das Paket **Azure.Messaging.EventGrid** aus NuGet hinzugefügt. Weitere Informationen finden Sie unter [Azure.Messaging.EventGrid](https://www.nuget.org/packages/Azure.Messaging.EventGrid/4.11.0).
