...
1.  Wählen Sie auf dem Blatt  **API-Option auswählen** die Option **Erstellen** im Feld **Azure Cosmos DB for NoSQL** aus.

1.  Konfigurieren Sie auf der Registerkarte **Grundlagen** der Seite **Azure Cosmos DB-Konto erstellen - Azure Cosmos DB for NoSQL** die folgenden Aktionen aus, und wählen Sie dann **Überprüfen und erstellen** aus:
...
1.  Überprüfen Sie auf der Registerkarte **Überprüfen und erstellen** auf der Seite **Azure Cosmos DB-Konto erstellen - Azure Cosmos DB for NoSQL** die Optionen, die Sie in den vorherigen Schritten ausgewählt haben. 
...
1.  Suchen Sie auf dem Blatt **Azure Cosmos DB-Konto** den Abschnitt **Settings** und wählen Sie den Link **Schlüssel** aus.

1.  Notieren Sie sich im Bereich **Schlüssel** auf der Registerkarte **Schlüssel für Lesen/Schreiben** die Werte der Textfelder **URI**, **PRIMÄRSCHLÜSSEL** und **PRIMÄRE VERBINDUNGSZEICHENFOLGE**. Sie verwenden diese Werte später in diesem Lab.
...
1.  Aktualisieren Sie die Eigenschaft  **AdventureWorksCosmosContext** – legen Sie ihren Wert auf die **PRIMÄRE VERBINDUNGSZEICHENFOLGE** des Azure Cosmos DB-Kontos fest, die Sie sich zuvor in diesem Lab notiert haben.
...
1.  Aktualisieren Sie die Eigenschaft **BlobContainerUrl** – legen Sie ihren Wert auf die Eigenschaft **URL** des Azure Storage-Blobcontainers mit dem Namen images **festlegen**, die Sie sich zuvor in diesem Lab notiert haben.
...
1.  Schließen Sie die Datei **Startup.cs**  ohne Änderungen.
