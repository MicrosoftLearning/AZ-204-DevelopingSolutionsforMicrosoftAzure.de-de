...
1. Klicken Sie als Nächstes auf **Freigegebene Zugriffstoken**, und generieren Sie ein Zugriffstoken mit den Standardeinstellungen, indem Sie auf **SAS-Token und URL generieren** klicken. Notieren Sie sich den Wert des **BLOB-SAS-Tokens**, da Sie dies später benötigen.
