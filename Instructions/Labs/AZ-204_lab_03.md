...
Um die Einhaltung der Unternehmensvorschriften sicherzustellen, implementieren Sie den sicheren Zugriff, indem Sie Shared Access Signatures und Datenlebenszyklusrichtlinien generieren. Sie testen den Zugriff auf den Inhalt auch über eine statische Website.
...
1. Führen Sie auf dem Blatt **Speicherkonto erstellen** auf der Registerkarte **Grundlagen** die folgenden Aktionen aus:
...
1. Stellen Sie auf der Registerkarte **Erweitert** sicher, dass **Zulassen der Aktivierung des anonymen Zugriffs auf einzelne Container** aktiviert ist. Überprüfen Sie die Einstellung, wenn sie nicht aktiviert ist.
