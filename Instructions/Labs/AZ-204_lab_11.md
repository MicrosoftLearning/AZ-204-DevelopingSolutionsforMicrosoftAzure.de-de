...
1. Navigieren Sie im Fenster von **Visual Studio Code** im **Explorer**-Bereich zum Verzeichnis **bin\Debug\net8.0**.

    > **Hinweis:** Um zu überprüfen, ob Sie sich im Verzeichnis **bin\Debug\net8.0** befinden, wählen Sie in Visual Studio Code im Menü „Datei“ die Option „Ordner öffnen“ aus, navigieren Sie zu **Allfiles (F):\\Allfiles\\Labs\\11\\Starter\\Api\\bin\\Release\\net8.0\win-x86\publish**, und wählen Sie dann **Ordner auswählen** aus.
