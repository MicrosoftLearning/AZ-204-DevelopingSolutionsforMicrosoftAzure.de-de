...
1.  Führen Sie auf dem Blatt **Web-App erstellen** auf der Registerkarte **Grundlagen** die folgenden Aktionen aus, und wählen Sie dann die Registerkarte **Überwachen** aus:
    ...
    | Abschnitt **App Service-Plan** |  Wählen Sie **Neu erstellen** aus. |
...
### <a name="exercise-4-application-insights-logging-with-net"></a>Übung 4: Application Insights-Protokollierung mit .NET

#### <a name="task-1-configure-logging-for-a-net-api-app"></a>Aufgabe 1: Konfigurieren der Protokollierung für eine .NET-API-App
