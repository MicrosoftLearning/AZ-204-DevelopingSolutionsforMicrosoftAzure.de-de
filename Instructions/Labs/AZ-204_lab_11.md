...
1.  Wählen Sie im Blatt **App Service** zuerst **Application Insights** und dann **Application Insights-aktivieren** aus.
...
1.  Zeichnen Sie die URL auf, die Sie für den Zugriff auf die Ausgabe im JSON-Format verwendet haben.
    ...
    > **Hinweis**: Die URL sollte das Format `https://smpapianu.azurewebsites.net/weatherforecast` aufweisen.
